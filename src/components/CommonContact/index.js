      ...
      <div className="common-contact-container">
        <div className="common-contact-left">
          ...
          <div className="common-contact-socialmedia-container">
            <img className="common-contact-socialmedia" alt={'socialmedia'} src={require('../../assets/facebook-outline.svg')}/>
            <img className="common-contact-socialmedia" alt={'socialmedia'} src={require('../../assets/twitter-outline.svg')}/>
            <img className="common-contact-socialmedia" alt={'socialmedia'} src={require('../../assets/naver-blog-outline.svg')}/>
            <img className="common-contact-socialmedia" alt={'socialmedia'} src={require('../../assets/linkedin-outline.svg')}/>
          </div>
