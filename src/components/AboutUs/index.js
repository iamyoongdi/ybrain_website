            ...
            <div className='about-us-company'>
              ...
              <div className='mission'>
                <div className='mission-image'>
                  <img alt={'mission'} src={require('../../assets/img-mission.png')} />
                </div>
                <div class='mission-text'>
                  <hr className='bar' width="70px;" height="2px;" border="solid 2px" color="#00afdb" align="left"></hr>
              ...
              <div className='vision'>
                <div className='vision-image'>
                  <img alt={'vision'} src={require('../../assets/img-vision.png')} />
                </div>
